...
class PosPacUavApplication:
    ...
    def _run_batch(self, main_cf: ControlFinder, batch_cf: ControlFinder, posbat_file: Path) -> None:
        """"""
    ...
    def create_extract_only_batchfile(
        ...
        template_file = Path(__file__).parent / "templates" / "extract_only_template.posbat"
